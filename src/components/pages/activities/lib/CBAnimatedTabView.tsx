...
export interface CBAnimatedTabViewProps<T>
  ...
  headerHeight: any,
  ListFooterComponent: any,ListHeaderComponent: any,showsVerticalScrollIndicator:any,nestedScrollEnabled: any
}
const CBAnimatedTabViewWithoutMemo = <T extends any>({
  ...
  refreshControl,
                                                       headerHeight,
  ListEmptyComponent,ListFooterComponent,ListHeaderComponent,showsVerticalScrollIndicator, nestedScrollEnabled
  ...
  return (
    <Animated.FlatList<T>
      ...
      style={{flex: 1 }} //tabbar is absolutely positioned
