                                ...
                                <View style={styles.rect}>
                                    ...
                                    <View style={styles.group2}>
                                        ...
                                        <View style={{marginTop:5}}>
                                            <TouchableOpacity disabled={(!(getRole(user,[CASHIER])) ? !(remarks) && getRole(user,[CASHIER]) : (!(checkNumber && isCheck) ? !(remarks) : !(bankName && checkNumber)) && getRole(user,[CASHIER]))} onPress={() => props.paymentMethod == "check" && !(checkNumber && isCheck)   ? setIsCheck(true) :  onConfirmation() }>
                                                <View style={[styles.confirmButton, {backgroundColor:((!(getRole(user,[CASHIER])) ? !(remarks) && getRole(user,[CASHIER]) : (!(isCheck) ? !(remarks && getRole(user,[CASHIER])) : !(bankName && checkNumber && getRole(user,[CASHIER])))))  ? disabledColor :primaryColor,}]}>
