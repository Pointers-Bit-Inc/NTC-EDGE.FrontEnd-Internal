...
export const ModalTab = props => {
    ...
    return <ViewPaged
        ...
        renderHeader={ (params) => {
            ...
            return (
                <View style={ { borderBottomWidth: hairlineWidth, borderBottomColor: "#d2d2d2", width: "100%", flexDirection: "row", alignItems: "center", justifyContent: "center",  backgroundColor : "#fff" } }>
                    <TabBar
