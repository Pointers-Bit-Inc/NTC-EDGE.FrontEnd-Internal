...
import {PullToRefreshHeaderRef, PullToRefreshProps} from "@pages/activities/pull-to-refresh/type";
        ...
        <Animated.View style={{  position: 'relative', flex: 1 }}>
            ...
            >
                <Animated.View style={[animatedStyle]}>
                    <Animated.View
                        style={[{ position: 'absolute', top: offset, left: 0, right: 0, bottom: 0, zIndex: 1, height: headerHeight }]}
                    >
