...
var RNScrollView = function (_ScrollView) {
  ...
  _createClass(RNScrollView, [{
    ...
    value: function render() {
      var reactElement = _get(RNScrollView.prototype.__proto__ || Object.getPrototypeOf(RNScrollView.prototype), 'render', this).call(this);
      if (_reactNative.Platform.OS === 'ios') {
        return reactElement;
      }
      var props = reactElement.props;

      var horizontal = props.horizontal,
          otherProps = _objectWithoutProperties(props, ['horizontal']);

      if (horizontal) {
        return _react2.default.createElement(AndroidHorizontalScrollView, otherProps);
      }
      return _react2.default.createElement(AndroidScrollView, otherProps);
    }
  }]);
...
if (_reactNative.Platform.OS !== 'ios') {
  ...
  AndroidHorizontalScrollView = (0, _reactNative.requireNativeComponent)('RNHorizontalScrollView', _reactNative.ScrollView, nativeOnlyProps);
}