...
const BASE_URL = 'https://dev-edge-application-processing-appsvc.azurewebsites.net';
const BASE_URL_NODE = 'https://dev-edge-application-processing-appsvc.azurewebsites.net';
