...
const BASE_URL = 'https://prod-edge-application-processing-appsvc.azurewebsites.net';
const BASE_URL_NODE = 'https://prod-edge-application-processing-appsvc.azurewebsites.net';
